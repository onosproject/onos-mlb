...
const (
	// TLSCacrt is TLS cacrt file contents
	...
	// TLSKey is TLS key file contents
	...
	// TLSCrt is TLC crt file contents
	...
	// ConfigJSON is JSON type config file contents
	ConfigJSON = "{\n  \"controller\": {\n    \"interval\": 5\n  }\n}"

	// TestTimeout is timeout time
	TestTimeout = 10 * time.Minute
	// TestInterval is test interval
	...
	// HighestThreshold is the highest threshold
	HighestThreshold = 101
	// LowestThreshold is the lowest threshold
	LowestThreshold = -1
)
